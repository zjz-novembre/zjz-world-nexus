...
final class NexusMacOSCredentialProviderViewController: ASCredentialProviderViewController {
  private var hostController: NSHostingController<NexusAutoFillPickerView>?
  ...
  private func show(credentials: [NexusCachedCredential]) {
    ...
    let next = NSHostingController(rootView: root)
